...
const Test = () => {
    ...
    const optionsObject = {
        'Spouse phone': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'adsfasdfasdfsd': ['equals to', 'not equals to'],
        'Last Visited Store': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'College Name': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Question 2 for feedback': ['equals to', 'not equals to'],
        'Question 3 for feedback': ['equals to', 'not equals to'],
        'Shipping street': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Name': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Created At': ['is', 'is before', 'is after', 'is on or after', 'range', 'relative to today', 'exists', "doesn't exist"],
        'WhatsApp ID': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Gender': ['equals to', 'not equals to'],
        'Shipping state': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'test property': ['equals to', 'not equals to'],
        'School Name': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Shipping country': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Shipping State': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'test is unique': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Shipping city': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'Question 1 for feedback': ['equals to', 'not equals to'],
        'WhatsApp Number': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'country': ['contains', 'not contains', 'starts with', 'ends with', 'equals to', 'not equals to', 'exists', "doesn't exist"],
        'total spent': ['between', 'less than or equal to', 'greater than or equal to', 'less than', 'greater than', 'equal to', 'not equal to'],
        'Is NRI': ['Yes', 'No', 'exists', "doesn't exist"]
    };
                                                ...
                                                <ul className='space-y-2'>
                                                    {radioOptions.map((option) => (
                                                        <li key={option} className='flex flex-col'>
                                                            ...
                                                            {selectedRadio === option && (optionsObj[selectedOption] === 'string' || optionsObj[selectedOption] === 'number') && (
                                                                <div className='ml-8'>
                                                                    <input
                                                                        type='text'
                                                                        className='h-10 rounded-md border border-input px-3 py-2 text-sm ring-offset-background font-medium focus-visible:outline-none w-full'
